          ...
          <div className="flex items-center gap-2">
            ...
            {true && (
              ...
              >
                ...
                {zkLogin.loading ? 'Redirecting…' : 'Google'}
              </button>
            )}
          </div>
        )}
                ...
                <div className="flex flex-col items-center justify-center py-24 gap-5 text-center select-none">
                  ...
                  {!effectiveAddress && (
                    <div className="flex flex-col items-center gap-3 mt-2">
                      <ConnectModal
                        trigger={
                          <button className="px-6 py-2.5 rounded-xl border border-purple-500/30 bg-purple-600/10 text-purple-300 text-sm font-medium hover:bg-purple-600/20 hover:border-purple-500/50 transition-colors">
                            Connect Wallet
                          </button>
                        }
                        open={connectOpen}
